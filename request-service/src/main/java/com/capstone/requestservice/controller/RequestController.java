...
public class RequestController {
    ...
    public ResponseEntity<RequestUuidDTO> saveRequest(@RequestBody AddRequestDetailDTO request, @RequestHeader("Authorization") String authorizationHeader){
        ...
        ResponseEntity<DepartmentInfoDTO> deptInfo = restTemplate.exchange("http://localhost-service:8082/v1/api/users/departments/uuid/" + userInfo.getBody().getDepartmentuuid(), HttpMethod.GET, entity, DepartmentInfoDTO.class);
